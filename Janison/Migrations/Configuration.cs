namespace Janison.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Janison.Data.JanisonContext>
    {
        ...
        protected override void Seed(Janison.Data.JanisonContext context)
        {
            ...
            enrollments.ForEach(s => context.Modules.AddOrUpdate(p => p.Name, s));
            context.SaveChanges();
        }
    }
}
